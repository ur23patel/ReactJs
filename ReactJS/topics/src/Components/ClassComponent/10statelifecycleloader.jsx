...
class Statelifecycle extends Component {
    ...
    render() {
        ...
        // }
        // console.log("render");
        console.log(this.state.laoder);
        return (
            <div>
                <p>Change Data</p>
                {/* {JSON.stringify(this.state.laoder)} */}
                {this.state.laoder ? <p>Data</p>: <img src="https://miro.medium.com/v2/resize:fit:1400/1*CsJ05WEGfunYMLGfsT2sXA.gif" alt="" /> } 
                ...
                {/* {HtmlDisp} */}
                <button onClick={()=>this.setState({laoder:!this.state.laoder})}>Click</button>
